...
These rules govern how Codex collaborates with the user on the TouchAnything project. They are non-negotiable unless the user explicitly amends this file.
