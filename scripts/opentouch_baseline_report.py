...
THE THREE DIAGNOSTICS THE USER ASKED FOR
  ...
  3. Cross-shard stability of the per-shard baselines: if a taxel's resting level moves
    ...
    python scripts/opentouch_baseline_report.py --cache ~/opentouch/cache
    python scripts/opentouch_baseline_report.py --k 0,1,2,3,5 --shards office_ml_p1,eat_ygf_p1
"""
